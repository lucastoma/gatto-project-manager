// GattoNero Color Matcher - v1.3 with Advanced Options UI
#target photoshop
...
writeToLog("--- Script execution started (v1.3) ---");
...
function main() {
    ...
    writeToLog("Configuration received: " + JSON.stringify(config));
...
function showConfigurationDialog() {
    ...
    var dialog = new Window("dialog", "GattoNero Color Matcher v1.3");
    ...
    thresholdInput.enabled = false; // Domyślnie wyłączone
    ...
    runButton.onClick = function() {
        ...
        // --- POPRAWIONA LOGIKA ---
        var thresholdValue = 0; // Ustawiamy domyślną wartość
        if (preserveExtremesCheckbox.value) { // Sprawdzamy próg TYLKO jeśli checkbox jest zaznaczony
        ...
        result = {
            ...
            preserveExtremes: preserveExtremesCheckbox.value, // Przekazujemy wartość checkboxa
            extremesThreshold: thresholdValue, // Przekazujemy poprawnie odczytaną lub domyślną wartość
...
function executeCurl(masterFile, targetFile, config) {
    ...
    if ($.os.indexOf("Windows") > -1) {
        ...
        try {
            ...
            var maxWaitTime = 30000; // Zwiększony timeout do 30s na wszelki wypadek
            ...
            if (stdOutput === "") { throw new Error("Nie otrzymano odpowiedzi od serwera."); }
